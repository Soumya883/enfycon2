    ...
    sections: [
      {
        heading: "AI Products",
        items: [
          { label: "iCognito AI", href: "/products/icognito", icon: Bot, desc: "Cognitive intelligence platform" },
          { label: "iDental AI", href: "/products/idental", icon: Heart, desc: "AI-powered dental diagnostics" },
          { label: "LexGenie AI", href: "/products/lexgenie", icon: Scale, desc: "Legal intelligence engine" },
          { label: "QuantFin AI", href: "/products/quantfin", icon: DollarSign, desc: "Quantitative finance AI" },
          { label: "PerformanceEdge AI", href: "/products/performanceedge", icon: TrendingUp, desc: "Employee performance AI" },
          { label: "iWAC AI", href: "/products/iwac", icon: Globe, desc: "Workforce analytics & compliance" },
          { label: "iVAAK AI", href: "/products/ivaak", icon: Cpu, desc: "Voice AI assistant platform" },
          { label: "TrueFix AI", href: "/products/truefix", icon: Wrench, desc: "Intelligent issue resolution" },
