...
export default function Footer() {
  return (
    <footer className="bg-[#050914] pt-24 pb-10 text-white border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
        
        {/* Brand Column */}
        <div className="lg:col-span-2">
          <Link href="/" className="inline-flex items-center mb-6">
            <img src="https://www.enfycon.com/images/logos/enfycon-logo-only.png" alt="Enfycon Logo" className="h-10 w-auto filter brightness-0 invert" />
            <span className="text-2xl font-bold ml-2 tracking-tight">enfycon</span>
          </Link>
          ...
          <div className="flex gap-3">
            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-[#3b5bdb] transition-colors">in</a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-[#3b5bdb] transition-colors">tw</a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-[#3b5bdb] transition-colors">fb</a>
          </div>
        </div>
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-gray-400 text-sm mb-4 leading-relaxed">Subscribe to our newsletter for the latest tech insights.</p>
          <form className="flex flex-col gap-3">
            <input type="email" placeholder="Email Address" className="bg-white/10 border border-transparent rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-[#3b5bdb] transition-colors" />
            <button type="submit" className="bg-[#3b5bdb] text-white px-4 py-3 rounded-lg font-bold flex justify-center items-center gap-2 hover:bg-[#364fc7] transition-colors text-sm w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between">
